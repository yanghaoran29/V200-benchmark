...
class TestQwen314bDynamicTensormapNoSpmdDecode(_Qwen3DecodeMixin, SceneTestCase):
...
@scene_test(level=2, runtime="tensormap_and_ringbuffer")
class TestQwen314bDynamicTensormapPartialSpmdDecode(_Qwen3DecodeMixin, SceneTestCase):
