...
def paged_attention_pypto_swpipe(  # noqa: PLR0913 -- fused Phase-0/attention API
    ...
    # Publish Q/K/V in a separate task. Its TaskId gives the 120-block consumer
    # a global producer-completion dependency without an in-kernel barrier.
    with pl.spmd(
        ROPE_CORES // 2,
