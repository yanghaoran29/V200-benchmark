...
AICORE void gate_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  using T = float;
  ...
  // pto: %gate_acc_all_inline795__rv_v2_view
  const int64_t v42 = 1;
  // pto: %gate_acc_all_inline795__rv_v2_view
  const int64_t v43 = 1;
  // pto: %gate_acc_all_inline795__rv_v2_view
  ...
  // pto: %gate_acc_all_inline795__rv_v2_pview
