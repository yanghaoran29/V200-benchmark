...
AICORE void up_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  using T = float;
  ...
  // pto: %up_acc_all_inline696__rv_v2_view
  const int64_t v42 = 1;
  // pto: %up_acc_all_inline696__rv_v2_view
  const int64_t v43 = 1;
  // pto: %up_acc_all_inline696__rv_v2_view
  ...
  // pto: %up_acc_all_inline696__rv_v2_pview
