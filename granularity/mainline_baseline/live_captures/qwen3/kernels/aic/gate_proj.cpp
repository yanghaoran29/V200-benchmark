...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: gate_acc_all_inline795__rv_v2
    __gm__ Tensor* gate_acc_all_inline795__rv_v2_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* gate_acc_all_inline795__rv_v2 = reinterpret_cast<__gm__ float*>(gate_acc_all_inline795__rv_v2_tensor->buffer.addr) + gate_acc_all_inline795__rv_v2_tensor->start_offset;
    ...
    gate_proj(mlp_norm_in_inline554__rv_v14, w_gate__ssa_v0, gate_acc_all_inline795__rv_v2, layer_hidden_base_inline694__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
