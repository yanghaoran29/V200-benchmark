...
def compressor_ratio4(
    ...
    with pl.spmd(
        OUT_DIM // OUT_TILE, name_hint="kv_score_proj", deps=[late_dep]
    ) as _kv_score_tid:
    ...
    with pl.at(level=pl.Level.CORE_GROUP, name_hint="rmsnorm_rope_cache_write"):
        ...
        for batch0 in pl.range(0, RMS_PAD_ROWS, RMS_PAD_TILE):
            ...
            for k0 in pl.range(0, NOPE_HEAD_DIM, HEAD_TILE):
                ...
                normed_kv[batch0 : batch0 + RMS_PAD_TILE, k0 : k0 + HEAD_TILE] = normed_chunk
            ...
            normed_kv[batch0 : batch0 + RMS_PAD_TILE, NOPE_HEAD_DIM : HEAD_DIM] = rope_rot
...
def build_tensor_specs(start_pos=None):
    ...
    return [
        ...
        TensorSpec("cmp_kv_cache", [CMP_BLOCK_NUM, CMP_STORAGE_BLOCK_SIZE, 1, HEAD_DIM], torch.bfloat16, init_value=init_cmp_kv_cache),
