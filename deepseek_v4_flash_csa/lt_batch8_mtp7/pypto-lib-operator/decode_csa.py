...
def attention_csa(
    ...
    n_wb_tile = T_TILE_BATCH // CSA_WB_TOKEN_TILE
    for wb_blk_lane in pl.spmd(N_BATCH_TILES, name_hint="csa_cache_writeback"):
        tile_i = wb_blk_lane
        t_base = tile_i * T_TILE_BATCH
        for wb_blk in pl.range(n_wb_tile):
            wb_t0 = t_base + wb_blk * CSA_WB_TOKEN_TILE
