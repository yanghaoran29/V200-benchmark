...
static __aicore__ void kv_hadamard(__gm__ float* v1, __gm__ bfloat16_t* v2, __gm__ bfloat16_t* v3) {
  ...
  // pto: %kv_final_inline63_inline1865__ssa_v0_view
  const int64_t v12 = 1;
  // pto: %kv_final_inline63_inline1865__ssa_v0_view
  const int64_t v13 = 1;
  // pto: %kv_final_inline63_inline1865__ssa_v0_view
  ...
  // pto: %normed_kv_inline159_inline1757__rv_v2_view
  const int64_t v20 = 1;
  // pto: %normed_kv_inline159_inline1757__rv_v2_view
  const int64_t v21 = 1;
  // pto: %normed_kv_inline159_inline1757__rv_v2_view
  ...
  for (int64_t v36 = v9; v36 < v6; v36 += v10) {
    // pto: %kv_proj_tile_inline61_inline1868__tile
    ;
    ...
    // pto: %normed_kv_inline159_inline1757__rv_v2_pview
    ;
    ...
    for (int64_t v46 = v9; v46 < v7; v46 += v11) {
      // pto: %hadamard_tile_inline133_inline1724__tile
      ;
      ...
      // pto: %kv_proj_tile_inline61_inline1868__tile_Left
      ;
      ...
      TMOV(v55, v37);
      // pto: %hadamard_tile_inline133_inline1724__tile_Right
      ;
      ...
      set_flag(PIPE_MTE1, PIPE_MTE2, EVENT_ID1);
      // pto: %kv_hadamard_acc_inline59_inline1870__tile
      ;
      ...
      set_flag(PIPE_M, PIPE_MTE1, EVENT_ID0);
      // pto: %kv_final_inline63_inline1865__iter_v3_pview
      ;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: kv_final_inline63_inline1865__ssa_v0
    __gm__ Tensor* kv_final_inline63_inline1865__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[0]);
    __gm__ float* kv_final_inline63_inline1865__ssa_v0 = reinterpret_cast<__gm__ float*>(kv_final_inline63_inline1865__ssa_v0_tensor->buffer.addr) + kv_final_inline63_inline1865__ssa_v0_tensor->start_offset;

    // Unpack tensor: normed_kv_inline159_inline1757__rv_v2
    __gm__ Tensor* normed_kv_inline159_inline1757__rv_v2_tensor = reinterpret_cast<__gm__ Tensor*>(args[1]);
    __gm__ bfloat16_t* normed_kv_inline159_inline1757__rv_v2 = reinterpret_cast<__gm__ bfloat16_t*>(normed_kv_inline159_inline1757__rv_v2_tensor->buffer.addr) + normed_kv_inline159_inline1757__rv_v2_tensor->start_offset;
    ...
    kv_hadamard(kv_final_inline63_inline1865__ssa_v0, normed_kv_inline159_inline1757__rv_v2, hadamard_idx__ssa_v0);
}
