...
static __aicore__ void q_seed(__gm__ float* v1) {
  ...
  // pto: %q_proj_inline570__ssa_v0_view
  const int64_t v12 = 1;
  // pto: %q_proj_inline570__ssa_v0_view
  const int64_t v13 = 1;
  // pto: %q_proj_inline570__ssa_v0_view
  ...
  for (int64_t v20 = v7; v20 < v8; v20 += v9) {
    ...
    // pto: %q_proj_inline570__iter_v1_pview
    ;
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: q_proj_inline570__ssa_v0
    __gm__ Tensor* q_proj_inline570__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor*>(args[0]);
    __gm__ float* q_proj_inline570__ssa_v0 = reinterpret_cast<__gm__ float*>(q_proj_inline570__ssa_v0_tensor->buffer.addr) + q_proj_inline570__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    q_seed(q_proj_inline570__ssa_v0);
}
