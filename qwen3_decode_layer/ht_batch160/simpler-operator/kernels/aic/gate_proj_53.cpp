...
static __aicore__ void gate_proj_53(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  using T = float;
  ...
  // pto: %gate_acc_all_inline559__rv_v128_view
  const int64_t v42 = 1;
  // pto: %gate_acc_all_inline559__rv_v128_view
  const int64_t v43 = 1;
  // pto: %gate_acc_all_inline559__rv_v128_view
  ...
  // pto: %gate_acc_all_inline559__rv_v128_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: gate_acc_all_inline559__rv_v128
    __gm__ Tensor* gate_acc_all_inline559__rv_v128_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* gate_acc_all_inline559__rv_v128 = reinterpret_cast<__gm__ float*>(gate_acc_all_inline559__rv_v128_tensor->buffer.addr) + gate_acc_all_inline559__rv_v128_tensor->start_offset;
    ...
    gate_proj_53(mlp_norm_in_inline719__rv_v158, w_gate__ssa_v0, gate_acc_all_inline559__rv_v128, layer_hidden_base_inline632__ssa_v9, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
