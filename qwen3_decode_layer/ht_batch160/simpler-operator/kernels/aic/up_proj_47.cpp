...
static __aicore__ void up_proj_47(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  using T = float;
  ...
  // pto: %up_acc_all_inline683__rv_v114_view
  const int64_t v42 = 1;
  // pto: %up_acc_all_inline683__rv_v114_view
  const int64_t v43 = 1;
  // pto: %up_acc_all_inline683__rv_v114_view
  ...
  // pto: %up_acc_all_inline683__rv_v114_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: up_acc_all_inline683__rv_v114
    __gm__ Tensor* up_acc_all_inline683__rv_v114_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* up_acc_all_inline683__rv_v114 = reinterpret_cast<__gm__ float*>(up_acc_all_inline683__rv_v114_tensor->buffer.addr) + up_acc_all_inline683__rv_v114_tensor->start_offset;
    ...
    up_proj_47(mlp_norm_in_inline719__rv_v142, w_up__ssa_v0, up_acc_all_inline683__rv_v114, layer_hidden_base_inline632__ssa_v8, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
