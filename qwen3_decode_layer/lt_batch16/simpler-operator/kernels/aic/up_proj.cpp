...
static __aicore__ void up_proj(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  ...
  // pto: %up_acc_0_inline528__rv_v2_view
  const int64_t v42 = 1;
  // pto: %up_acc_0_inline528__rv_v2_view
  const int64_t v43 = 1;
  // pto: %up_acc_0_inline528__rv_v2_view
  ...
  // pto: %up_acc_0_inline528__rv_v2_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: up_acc_0_inline528__rv_v2
    __gm__ Tensor* up_acc_0_inline528__rv_v2_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* up_acc_0_inline528__rv_v2 = reinterpret_cast<__gm__ float*>(up_acc_0_inline528__rv_v2_tensor->buffer.addr) + up_acc_0_inline528__rv_v2_tensor->start_offset;
    ...
    up_proj(mlp_norm_in_inline525__rv_v14, w_up__ssa_v0, up_acc_0_inline528__rv_v2, layer_hidden_base_inline545__ssa_v0, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
