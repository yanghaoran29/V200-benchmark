...
static __aicore__ void up_proj_5(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int32_t v5, int32_t v6) {
  ...
  // pto: %up_acc_all_inline761__rv_v16_view
  const int64_t v42 = 1;
  // pto: %up_acc_all_inline761__rv_v16_view
  const int64_t v43 = 1;
  // pto: %up_acc_all_inline761__rv_v16_view
  ...
  // pto: %up_acc_all_inline761__rv_v16_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: up_acc_all_inline761__rv_v16
    __gm__ Tensor* up_acc_all_inline761__rv_v16_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* up_acc_all_inline761__rv_v16 = reinterpret_cast<__gm__ float*>(up_acc_all_inline761__rv_v16_tensor->buffer.addr) + up_acc_all_inline761__rv_v16_tensor->start_offset;
    ...
    up_proj_5(mlp_norm_in_inline677__rv_v30, w_up__ssa_v0, up_acc_all_inline761__rv_v16, layer_hidden_base_inline569__ssa_v1, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
