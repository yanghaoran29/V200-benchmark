...
static __aicore__ void up_proj_35(__gm__ bfloat16_t* v1, __gm__ bfloat16_t* v2, __gm__ float* v3, int64_t v4, int64_t v5) {
  using T = float;
  ...
  // pto: %up_acc_1_inline620__iter_v156_view
  const int64_t v42 = 1;
  // pto: %up_acc_1_inline620__iter_v156_view
  const int64_t v43 = 1;
  // pto: %up_acc_1_inline620__iter_v156_view
  ...
  // pto: %up_acc_1_inline620__iter_v156_pview
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    // Unpack tensor: up_acc_1_inline620__iter_v156
    __gm__ Tensor* up_acc_1_inline620__iter_v156_tensor = reinterpret_cast<__gm__ Tensor*>(args[2]);
    __gm__ float* up_acc_1_inline620__iter_v156 = reinterpret_cast<__gm__ float*>(up_acc_1_inline620__iter_v156_tensor->buffer.addr) + up_acc_1_inline620__iter_v156_tensor->start_offset;
    ...
    // Unpack scalar: n0_inline560__ssa_v52
    union { uint64_t u64; int64_t val; } n0_inline560__ssa_v52_conv;
    n0_inline560__ssa_v52_conv.u64 = args[4];
    int64_t n0_inline560__ssa_v52 = n0_inline560__ssa_v52_conv.val;

    // Forward to ptoas-generated function
    up_proj_35(mlp_norm_in_inline481__rv_v62, w_up__ssa_v0, up_acc_1_inline620__iter_v156, layer_hidden_base_inline508__ssa_v3, n0_inline560__ssa_v52);
}
