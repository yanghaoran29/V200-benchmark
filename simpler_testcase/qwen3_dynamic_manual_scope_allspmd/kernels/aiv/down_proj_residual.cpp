...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t* args)
{
    ...
    down_proj_residual(down_tile__ssa_v1, resid1_tile__ssa_v1, out__iter_v1, cur_valid__ssa_v1, b0__idx_v0, USER_BATCH_DYN, __pypto_spmd_block_idx, __pypto_spmd_block_num);
}
