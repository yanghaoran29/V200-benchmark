    ...
    PTO2_SCOPE() {
        ...
        for (int64_t b0 = 0; b0 < batch_padded; b0 += 16) {
            PTO2_SCOPE() {
                ...
                const Tensor& gate_tile__ssa_v1 = gate_tile;
                ...
                const Tensor& up_tile__ssa_v1 = up_tile;

                // Spmd silu_spmd: silu
                Arg params_t14;
                params_t14.add_input(gate_tile__ssa_v1);
                params_t14.add_input(up_tile__ssa_v1);
                params_t14.add_inout(mlp_tile);
                params_t14.launch_spec.set_block_num(34);
                rt_submit_aiv_task(15, params_t14);
                const Tensor& mlp_tile__ssa_v1 = mlp_tile;

                // Spmd down_proj_spmd: down_proj
                Arg params_t15;
                params_t15.add_input(mlp_tile__ssa_v1);
                ...
                const Tensor& down_tile__ssa_v1 = down_tile;

                // Spmd down_proj_residual_spmd: down_proj_residual
                Arg params_t16;
                params_t16.add_input(down_tile__ssa_v1);
